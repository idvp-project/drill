...
<@pp.changeOutputFile name="/org/apache/drill/exec/expr/fn/impl/RepeatedContainsAnyFunctions.java" />
 ...
 */
public class RepeatedContainsAnyFunctions {

  private RepeatedContainsAnyFunctions() {
  }

  <#list repeatedTypes.types as type>
  @FunctionTemplate(name = "repeated_contains_any", scope = FunctionTemplate.FunctionScope.SIMPLE)
