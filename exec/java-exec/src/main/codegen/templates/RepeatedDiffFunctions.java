...
<@pp.changeOutputFile name="/org/apache/drill/exec/expr/fn/impl/RepeatedDiffFunctions.java" />
 ...
 */
public class RepeatedDiffFunctions {

  private RepeatedDiffFunctions() {
  }

  <#list repeatedTypes.types as type>
  @FunctionTemplate(name = "repeated_diff", scope = FunctionTemplate.FunctionScope.SIMPLE)
  public static class RepeatedDiff${type.type} implements DrillSimpleFunc {
