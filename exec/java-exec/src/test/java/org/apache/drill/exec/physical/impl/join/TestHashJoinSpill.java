...
public class TestHashJoinSpill extends PhysicalOpUnitTestBase {
  ...
  public void testSimpleHashJoinSpill() {
    testSimpleHashJoinSpillInternal();
  }

  @SuppressWarnings("unchecked")
  @Test
  // Should spill, including recursive spill
  public void testSimpleHashJoinSpillSnappy() throws Exception {
    setSpillCompression("snappy");
    testSimpleHashJoinSpillInternal();
  }
  ...
  @Test
  // Should spill, including recursive spill
  public void testSimpleHashJoinSpillGzip() throws Exception {
    setSpillCompression("gzip");
    testSimpleHashJoinSpillInternal();
  }
  ...
  @Test
  // Should spill, including recursive spill
  public void testSimpleHashJoinSpillUnknown() throws Exception {
    setSpillCompression("unknown");
    try {
      testSimpleHashJoinSpillInternal();
  ...
  private void testSimpleHashJoinSpillInternal() {
  ...
  private void setSpillCompression(String compression) throws Exception {
